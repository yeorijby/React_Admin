...
const { mockDataContacts } = require('./data/mockDataIsContacts.js');
...
app.get('/contacts', async (요청, 응답) => { 
    try {
        const mockDataMyContacts = await RA_Member.find();
        console.log(mockDataMyContacts);
        응답.json(mockDataMyContacts);
    } catch (error) {
